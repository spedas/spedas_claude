...
| `spedas_agent_kit` commit | `a6e8f7e486c3d7fdfc0aeb17fc1b3a9ffe8adfd0` | `.mcp.json` `--from git+https://github.com/spedas/spedas_agent_kit.git@a6e8f7e486c3d7fdfc0aeb17fc1b3a9ffe8adfd0` |
...
- `dependency_audit.resolved_spedas_agent_kit_commit == "a6e8f7e486c3d7fdfc0aeb17fc1b3a9ffe8adfd0"`
...
- `tool_count == 13` and `resource_count == 66` for the current base/resource surface
