...
| `spedas_agent_kit` commit | `4c1fd134ff9d327ebb3f0efe8ee963b9bb7a8aa0` | `.mcp.json` `--from git+https://github.com/spedas/spedas_agent_kit.git@4c1fd134ff9d327ebb3f0efe8ee963b9bb7a8aa0` |
...
"args": ["--with", "mcp>=1.26.0,<2",
         "--from", "git+https://github.com/spedas/spedas_agent_kit.git@4c1fd134ff9d327ebb3f0efe8ee963b9bb7a8aa0",
         "spedas-agent-kit"]
```
...
- `dependency_audit.resolved_spedas_agent_kit_commit == "4c1fd134ff9d327ebb3f0efe8ee963b9bb7a8aa0"`
...
- `tool_count == 13` and `resource_count == 67` for the current base/resource surface
...
```bash
gh api repos/spedas/spedas_agent_kit/commits/4c1fd134ff9d327ebb3f0efe8ee963b9bb7a8aa0 >/dev/null
```
