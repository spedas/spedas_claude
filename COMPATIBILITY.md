...
| `spedas_agent_kit` commit | `8fcfc7dd0e6f01800f301590ed8213eb33683582` | `.mcp.json` `--from git+https://github.com/spedas/spedas_agent_kit.git@8fcfc7dd0e6f01800f301590ed8213eb33683582` |
...
- `dependency_audit.resolved_spedas_agent_kit_commit == "8fcfc7dd0e6f01800f301590ed8213eb33683582"`
...
- `tool_count == 13` and `resource_count == 65` for the current base/resource surface
...
```bash
gh api repos/spedas/spedas_agent_kit/commits/8fcfc7dd0e6f01800f301590ed8213eb33683582 >/dev/null
```
