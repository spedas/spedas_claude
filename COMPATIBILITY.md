...
| `spedas_agent_kit` commit | `b30d5d6fd05c56ee46ab7c3f2192edd7288a25cb` | `.mcp.json` `--from git+https://github.com/spedas/spedas_agent_kit.git@b30d5d6fd05c56ee46ab7c3f2192edd7288a25cb` |
...
- `dependency_audit.resolved_spedas_agent_kit_commit == "b30d5d6fd05c56ee46ab7c3f2192edd7288a25cb"`
...
```bash
gh api repos/spedas/spedas_agent_kit/commits/b30d5d6fd05c56ee46ab7c3f2192edd7288a25cb >/dev/null
```
