...
|---|---|---|
| 0.1.0 | `git+https://github.com/spedas/spedas_agent_kit.git@fb5d4005fc5870ac4b8a94c1221efca4703b1c3a` (pinned commit, no extras) | `mcp>=1.26.0,<2` |
...
- Repin the Claude Code wrapper to Agent Kit
  `fb5d4005fc5870ac4b8a94c1221efca4703b1c3a`, keeping the wrapper aligned with
  the latest runtime-neutral analysis-bundle provenance guidance, no-fetch
  smoke coverage, MCP-first geomagnetic overview route gates, and external
  PySPEDAS route-gate hardening in the upstream Agent Kit.
