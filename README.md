...
- `skills/` — Claude-packaged copy of the 31 canonical Agent Kit shared skills; start with `skills/spedas-skills-index/SKILL.md` or `skills/spedas-workflow/SKILL.md`.
...
```json
{
  ...
  "dependency_audit": {
    "from_arg": "git+https://github.com/spedas/spedas_agent_kit.git@8fcfc7dd0e6f01800f301590ed8213eb33683582",
    "resolved_spedas_agent_kit_commit": "8fcfc7dd0e6f01800f301590ed8213eb33683582",
    "ref_kind": "commit",
    "is_pinned": true,
