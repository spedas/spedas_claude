...
- `skills/` — Claude-packaged copy of the 36 canonical Agent Kit shared skills; start with `skills/spedas-skills-index/SKILL.md` or `skills/spedas-workflow/SKILL.md`.
...
```json
{
  ...
  "dependency_audit": {
    "from_arg": "git+https://github.com/spedas/spedas_agent_kit.git@56dd235ef898f01e42550884b87913bb44030086",
    "resolved_spedas_agent_kit_commit": "56dd235ef898f01e42550884b87913bb44030086",
    "ref_kind": "commit",
    "is_pinned": true,
