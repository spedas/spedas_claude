...
```json
{
  ...
  "dependency_audit": {
    "from_arg": "git+https://github.com/spedas/spedas_agent_kit.git@e6e27a2a2ced1468eeef93ab0d0e1870a57538d9",
    "resolved_spedas_agent_kit_commit": "e6e27a2a2ced1468eeef93ab0d0e1870a57538d9",
    "ref_kind": "commit",
    "is_pinned": true,
