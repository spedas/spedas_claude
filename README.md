...
- `skills/` — Claude-packaged copy of the 32 canonical Agent Kit shared skills; start with `skills/spedas-skills-index/SKILL.md` or `skills/spedas-workflow/SKILL.md`.
...
```json
{
  ...
  "dependency_audit": {
    "from_arg": "git+https://github.com/spedas/spedas_agent_kit.git@a6e8f7e486c3d7fdfc0aeb17fc1b3a9ffe8adfd0",
    "resolved_spedas_agent_kit_commit": "a6e8f7e486c3d7fdfc0aeb17fc1b3a9ffe8adfd0",
    "ref_kind": "commit",
    "is_pinned": true,
